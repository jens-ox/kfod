...
function HighlightQuery({ text, query }: { text: string; query: string }) {
  return (
    <Highlighter
      highlightClassName="group-aria-selected:underline bg-transparent text-sky-600"
      searchWords={[query]}
      autoEscape={true}
...
function SearchResult({
  ...
  return (
    ...
    >
      <div id={`${id}-title`} aria-hidden="true" className="text-sm text-slate-700 group-aria-selected:text-sky-600">
  ...
  return (
    <>
      ...
      >
        ...
        <span className="sr-only md:not-sr-only md:ml-2 md:text-slate-500">Suchen</span>
        {modifierKey && (
          <kbd className="ml-auto hidden font-medium text-slate-400">

  ...
  return (
    ...
    >
      ...
      <div className="grow basis-0">
        <Link href="/" aria-label="Home page" className="font-semibold">
          <span className="hidden md:inline-block">Kommunaler Fahrplan Open Data</span>
          <span className="inline-block md:hidden">KFOD</span>
        </Link>
      </div>
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:grow">
        <Link href="https://github.com/jens-ox/kfod" className="group" aria-label="GitHub">
